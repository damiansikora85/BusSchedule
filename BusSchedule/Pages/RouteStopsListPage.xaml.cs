...
public partial class RouteStopsListPage : ContentPage
{
    private RoutePageViewModel _viewModel;
    private bool _firstTimeAppearing = true;

    public RouteStopsListPage()
    {
    }

    public RouteStopsListPage(Routes route, string destinationName, int? direction)
    {
